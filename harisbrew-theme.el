;;; harisbrew-theme.el --- haris theme

;; Author: Charalambos Themistocleous themistocleous@gmail.com
;; URL: www.charalambosthemistocleous.com
;; Version: 0.01
...
(custom-theme-set-faces
 ...
 '(modeline-buffer-id ((t (:background "black" :foreground "green"))))
 '(modeline-mousable ((t (:background "black" :foreground "green"))))
 '(modeline-mousable-minor-mode ((t (:background "black" :foreground "green"))))
 '(mouse ((t (nil))))
 ...
 '(paren-match  ((t (:background "turquoise" :foreground "coral"))))
 '(paren-mismatch ((t (:background "purple" :foreground "white"))))
 ...
 '(reb-match-3 ((t (nil))))
 '(red ((t (nil))))
 '(region ((t (:background "dodger blue" :foreground "black"))))
 '(right-margin ((t (nil))))
...
(provide-theme 'harisbrew)

;;; harisbrew-theme.el ends here
